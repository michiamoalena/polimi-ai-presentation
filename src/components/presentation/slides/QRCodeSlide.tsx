...
const QRCodeSlide = ({ content, onUpdate, pollUrl, liveCount }: Props) => (
  <div className="w-full h-full flex items-center justify-center gap-12">
    <GlassPanel className="flex flex-col items-center p-10">
      <EditableText
        as="h2"
      ...
      <div className="bg-white p-4 rounded-2xl shadow-lg">
        <QRCodeSVG value={pollUrl} size={280} level="H" />
      </div>
      <EditableText
        as="p"
    ...
    <GlassPanel className="flex flex-col items-center p-10 min-w-[300px]">
      <EditableText
        as="h3"
